...
namespace Web.Common
{
    public class NamespaceHttpControllerSelector : IHttpControllerSelector
    {
        ...
        public HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            if (controllerName == null) throw new HttpResponseException(System.Net.HttpStatusCode.NotFound);

            var namespaceName = GetVersion(routeData);
            if (namespaceName == null) throw new HttpResponseException(System.Net.HttpStatusCode.NotFound);
